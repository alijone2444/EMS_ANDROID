    ...
    <View style={{ height: "100%", width: '100%', display: 'flex', justifyContent: "center" }}>
      ...
      <View style={{ display: 'flex', justifyContent: 'center', height: "60%", backgroundColor: 'transparent' }}>
        <View>
          ...
          <View style={{ backgroundColor: "rgba(102, 68, 102, 0.5)", height: '65%', position: 'relative' }}></View>
          <Svg
            height={100}
            width="100%"
            viewBox="0 0 1440 220">
      ...
      <View style={{ position: 'absolute', width: '100%', alignItems: 'center', backgroundColor: "rgba(102, 68, 102, 0.5)" }}>
